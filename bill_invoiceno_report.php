...
<div id="content" class="container_12"> 
  ...
  <div class="grid_12"> 
	...
	$invoice='';
	if(isset($_POST["txt_invno"]))
	{
	
	
		$invoice=trim($_POST["txt_invno"]);
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
      <tr>
        <td><form id="frm" name="frm" action="bill_invoiceno_report.php" method="post">
        <fieldset>
        ...
        <br/>
            <table width="100%" align="left" cellpadding="10" cellspacing="0" style="font-family:'Trebuchet MS';color:#000;">
              ...
              <tr>
                <td width="150" valign="top" style="">Invoice No:</td>
                <td colspan="2"><input id="txt_invno" name="txt_invno" type="text" class="inputs" autocomplete="off" tabindex="" value="<?php print $invoice; ?>"  /></td>
    ...
    <table width="100%" align="left" class="listtbl" id="listtbl" cellpadding="10" border="1" cellspacing="0" >
        ...
        <?php
			...
			$sqlSubject="SELECT * FROM `tbl_invoice` WHERE `iv_ivno` LIKE '%$invoice%' GROUP BY `iv_ivno`";
			//print $sqlSubject; 
...
//`iv_ivno``iv_ivdate``iv_ordno``iv_orddate``iv_buydet` iv_grdtot
        ...
        <tr <?php if(($i%2)==0){ ?> class="alternate" <?php } ?>>
          ...
          <td align="center"><a class="fancybox fancybox.iframe" href="report.php?sid=<?php print $iv_ivno; ?>" title="View Details">View</a></td>
        </tr>
        <?php
  				}
  	}
