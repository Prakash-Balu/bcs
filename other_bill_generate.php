...
<?php
			...
			$sqlDept="SELECT `comp_igst` FROM `tbl_setting`";
...
<div id="content" class="container_12"> 
  ...
  <div class="grid_12"> 
				...
				if(isset($_GET["status"]))
	{
		...
		if($status==2)
		{
			print "Insert failed...!";
				...
				$invoice=$res["auto_oinvoice"];
				$auto_invoice="BCSO".$res["auto_oinvoice"];
    ...
    <form id="frm" name="frm" action="other_bill_save.php" method="post">
    <table width="100%" align="left" class="listtbl" cellpadding="10" border="1" cellspacing="0" >
        ...
        <input type="hidden" name="hdn_invoice" id="hdn_invoice" value="<?php print $invoice;  ?>" />
          ...
          <td width="12%" align="left" scope="col"><input type="text" name="txt_ivno" id="txt_ivno" value="<?php print $auto_invoice; ?>" /></th>
      ...
      <tr>
        ...
        <tr>
        <input type="hidden" name="cgst" id="cgst" value="<?php print $igst; ?>" />
          <th  align="right" colspan="3" scope="col">IGST <?php print $igst; ?>%:</th>
